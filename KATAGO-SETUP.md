...
ค่าที่ใช้กับ Render Free คือ 32 visits, 1 root symmetry และ timeout 120 วินาที
เพื่อให้ KataGo ทำงานได้ใน RAM 512 MB และ CPU 0.1 ของแผนฟรี โดยยังใช้ neural network จริง
AI อาจใช้เวลาคิดต่อหนึ่งตาหลายสิบวินาที โดยเฉพาะกระดาน 19×19 และการเข้าใช้งานครั้งแรก
หลังบริการหลับอาจต้องรอปลุกประมาณ 1 นาที หากต้องการให้เร็วและนิ่งขึ้นให้เปลี่ยน Render
เป็น Starter หรือสูงกว่า

> Docker แบบพร้อมใช้เน้นให้รันได้ในข้อจำกัดของแผน Free จึงไม่ได้บรรจุ
...
20 วินาที ส่วน Docker CPU บน Render Free จะกำหนดทับเป็น 32, 1 และ 120 วินาทีตามลำดับ
